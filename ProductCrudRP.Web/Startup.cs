...
using ProductCrudRP.DataAccess;
using ProductCrudRP.Core.DataInterface;
using ProductCrudRP.DataAccess.Repositories;

namespace ProductCrudRP.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ProductCrudRPContext>(opts => opts.UseSqlite(connection));
